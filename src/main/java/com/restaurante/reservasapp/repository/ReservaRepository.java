...
public interface ReservaRepository extends MongoRepository<ReservaEntity, String> {
  ...
  // Busca reservas para una mesa en una fecha y hora específica
    List<ReservaEntity> findByMesaIdAndFechaAndHora(String mesaId, String fecha, String hora);
    
    // Busca reservas de un usuario por experiencia (sector)
    List<ReservaEntity> findByUsuarioIdAndExperiencia(String usuarioId, String experiencia);
